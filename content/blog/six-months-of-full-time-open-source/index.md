...
It's been an exhilarating journey so far, and I'm happy to say I'm going to keep doing it for the forseeable future!
...
-   Numerous bugfixes, documentation improvements, and features in TypeScript ESLint
...
-   Took over maintenance of [eslint-plugin-expect-type](https://github.com/JoshuaKGoldberg/eslint-plugin-expect-type) and fixed a few bugs
-   A [couple bugfixes](https://github.com/microsoft/TypeScript/pulls?q=+is%3Apr+author%3AJoshuaKGoldberg+is%3Amerged+created%3A2022-02-28..2023-01-01) in TypeScript itself
-   Released [learningtypescript.com](https://learningtypescript.com) with dozens of free articles and projects for TypeScript
-   Released [chooseyouframework.dev](https://chooseyourframework.dev), which involved a whole suite of refactors and improvements to EightBittr
-   Released the [Refined Saved Replies](https://github.com/JoshuaKGoldberg/refined-saved-replies) Chrome extension
...
For reference, $600/month of a full time job is roughly half the federal minimum wage ($7.25 per hour, or ~$1,200/month).
...
I've brought my income up to tolerable levels by private company consulting, releasing the [_Learning TypeScript_ book](https://learningtypescript.com), and reviewing occasional pull requests on [pullrequest.com](https://pullrequest.com).
...
-   Learn the internals of TypeScript ESLint so I can meaningfully work on its at-scale performance issues
-   Bring TypeStat up to the point where it's stable and working on common React projects
-   Standardize tooling across my smaller repos -[emojisplosion](https://github.com/JoshuaKGoldberg/emojisplosion), [konamomijisplosion](https://github.com/JoshuaKGoldberg/konamimojisplosion), [console-fail-test](https://github.com/JoshuaKGoldberg/console-fail-test), [eslint-plugin-expect-type](https://github.com/JoshuaKGoldberg/eslint-plugin-expect-type), ...- and tackle their immediately useful bugfixes and features
...
-   [learningtypescript.com](https://learningtypescript.com) contains links to buy my _Learning TypeScript_ book. A five star review is surprisingly helpful in promoting it, too.
...
If you or your coworkers write TypeScript code, it might just be in your best interest to sponsor me so I can improve your developer experience.
Please let me know over [email](mailto:blog@joshuakgoldberg.com "my email") or [@JoshuaKGoldberg on Twitter](https://twitter.com/JoshuaKGoldberg) if there are any projects in particular that you're interested in.
